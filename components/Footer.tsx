...
export default function Footer() {
  return (
    <footer className="bg-grit-black border-t border-grit-grey py-16">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          {/* Nav */}
          <div>
            <p className="font-body text-grit-sand text-xs tracking-widest uppercase mb-4">Navigation</p>
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="font-body text-grit-white/70 text-sm hover:text-grit-orange transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                className="w-10 h-10 border border-grit-grey flex items-center justify-center text-grit-white hover:text-grit-orange hover:border-grit-orange transition-colors"
              >
            ...
            <div className="mt-6 space-y-1">
              <p className="font-body text-grit-muted text-xs">gritarena@outlook.com</p>
              <p className="font-body text-grit-muted text-xs">0807 859 1455</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-grit-grey pt-8">
          <p className="font-body text-grit-muted text-xs text-center">
            © 2026 GRIT Quad Biking Arena. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
