...
export const metadata: Metadata = {
  ...
  description:
    "Host your next event at GRIT Quad Biking Arena, Port Harcourt. Birthday parties, corporate outings, team bonding, and private track days.",
};
...
const eventTypes = [
  ...
  {
    icon: (
      <Building2 size={40} className="text-grit-orange" aria-hidden="true" />
    ),
      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <p className="font-body text-grit-white/60 text-base max-w-lg">
            From birthday parties to corporate bonding days — GRIT handles the
            terrain. You bring the crew.
          </p>
        </div>
      </section>
              ...
              >
                <div className="flex flex-col md:flex-row gap-8">
                  ...
                  <div className="flex-1">
                    <span className="font-body text-grit-orange text-xs tracking-widest uppercase">
                      {event.type}
                    </span>
                    ...
                    <ul className="space-y-2 mb-6">
                      {event.highlights.map((h) => (
                        ...
                        >
                          <Check
                            size={14}
                            className="text-grit-orange shrink-0 mt-0.5"
                            aria-hidden="true"
                          />
                          {h}
                        </li>
                  ...
                  <div className="shrink-0 md:text-right flex flex-col justify-between gap-6">
                    <div>
                      <p className="font-display text-grit-orange text-3xl md:text-4xl leading-none">
                        19 July
                      </p>
                    ...
                    <div className="flex flex-col gap-3">
                      <p className="font-body text-grit-sand text-xs">
                        {event.spots}
                      </p>
                      <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {eventTypes.map((event) => (
              ...
              >
                ...
                <h3 className="font-display text-grit-white text-3xl leading-none mb-4">
                  {event.title}
                </h3>
                <p className="font-body text-grit-white/60 text-sm leading-relaxed mb-8">
                  {event.description}
                </p>
                <a
                  href="/booking"
      ...
      <section className="py-24 bg-grit-orange">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="font-body text-grit-black/70 text-lg max-w-md mx-auto mb-10">
            Tell us what you have in mind — we&apos;ll put together a custom
            quote.
          </p>
          ...
          <div className="max-w-3xl mx-auto">
            {[
              ...
              },
              {
                ...
                a: "Fridays and Saturdays — 10:00am to 6:00pm. Sunday opening launched 19 July 2026.",
              },
              {
              ...
              <div
                key={faq.q}
                data-reveal
                className="opacity-0-init border-t border-grit-grey py-8"
              >
                <h3 className="font-body text-grit-white text-sm font-semibold mb-3">
                  {faq.q}
                </h3>
                <p className="font-body text-grit-muted text-sm leading-relaxed">
                  {faq.a}
                </p>
              </div>
            ))}
